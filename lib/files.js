 ...
 */
export const getLastUpdated = (path) => fs.statSync(getPath(path)).mtime.toISOString();
 ...
 */
export const getFilesInDirectory = (directory) => fs.readdirSync(getPath(directory));
