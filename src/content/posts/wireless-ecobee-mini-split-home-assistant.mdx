...
coverImage:
    url: ~cover-ecobee-mini-split-home-assistant.jpg
    width: 1600
    height: 900
date: '2022-06-22'
---
...
![Screenshot of Home Assistant integrations](~screenshot-integrations-home-kit-controller-kumo-mini-split.png)
...
![ecobee-thermostat-wiring.jpg](~ecobee-thermostat-wiring.jpg)
...
![Ecobee thermostat Installation Settings screen](~ecobee-installation-settings.jpg)

4\. Tap “Equipment”

![Ecobee thermostat Equipment settings screen](~ecobee-equipment.jpg)

5\. Tap “Reconfigure Equipment”

![Ecobee thermostat Homeowner or Pro? settings screen](~ecobee-homeowner-or-pro.jpg)

6\. Select “I’m a homeowner” and tap “Next”

![Ecobee thermostat Wire Detection screen](~ecobee-wire-detection.jpg)

7\. Select “No, Rc and Rh are connected” and tap “Next”

![Ecobee thermostat Previouly Configured Wiring Confirmation screen](~ecobee-prev-configured-wiring-correct.jpg)

8\. A diagram showing which wiring terminals are configured should be visible with the question “Is this correct?”. Tap “No”.

![Ecobee thermostat Previously Configured Wiring Modify screen](~ecobee-prev-configured-wiring.jpg)
...
![Ecobee thermostat Manual Wiring Configuration screen](~ecobee-manual-wire-config.jpg)
...
![Ecobee thermostat Accessory Options screen](~ecobee-accessory-options.jpg)

11\. On the next screen select “No accessory installed” and tap “Next”.

![Ecobee thermostat Temperature Scale screen](~ecobee-f-or-c.jpg)
...
![whiteboard-logic-flow.jpg](~whiteboard-logic-flow.jpg)
...
![Node-RED Flow](~screenshot-node-red-flow.png)

I'll walk through each node in the flow.

### ![Downstairs Thermostat {noDivWrap}](~node-downstairs-thermostat.png) 
...
![Downstairs Thermostat node details](~screenshot-events-state-node-downstairs-thermostat.png)
...
### ![Cooling? {noDivWrap}](~node-cooling.png) 
...
![Cooling switch node details](~screenshot-switch-node-coolling.png)


### ![Different Temps {noDivWrap}](~node-different-temps.png) 
...
![Different temp switch node details](~screenshot-switch-node-different-temps.png)


### ![Cool or Off {noDivWrap}](~node-cool-or-off.png) 
...
![Cool or off switch node details](~screenshot-switch-node-cool-or-off.png)


### ![Turn on AC {noDivWrap}](~node-turn-on-ac.png) 
...
![Turn on AC call service node details](~screenshot-call-service-node-turn-on-ac.png)


### ![Set Temp {noDivWrap}](~node-set-temp.png) 
...
![Set temp call service node details](~screenshot-call-service-node-set-temp.png)

### ![Turn Off AC {noDivWrap}](~node-turn-off-ac.png) 
...
![Turn off AC call service node details](~screenshot-call-service-node-turn-off-ac.png)
