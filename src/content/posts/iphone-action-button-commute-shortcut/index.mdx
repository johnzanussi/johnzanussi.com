---
title: iPhone 15 Pro Action Button Shortcut for Commuting
excerpt: Using a custom iOS Shortcut to open my train ticketing app using the iPhone 15 Pro action button only while commuting
cover: "@/content/posts/iphone-action-button-commute-shortcut/cover-iphone-action-button.jpg"
date: '2023-10-28'
hiddenIntro: true
---
...
import imgLIRRDigitalTicket from '@/content/posts/iphone-action-button-commute-shortcut/lirr-digital-ticket.jpg';
import imgLIRRPhysicalTicket from '@/content/posts/iphone-action-button-commute-shortcut/lirr-physical-ticket.jpg';
...
<Figure
    ...
    <Grid columns={[5, 7]}>
        ...
        ![Screenshot of a LIRR digital ticket noDivWrap](@/content/posts/iphone-action-button-commute-shortcut/lirr-digital-ticket.jpg)

        ![A physical paper LIRR ticket noDivWrap](@/content/posts/iphone-action-button-commute-shortcut/lirr-physical-ticket.jpg)
...
![Screenshot of Apple Calendar with a "Commuting Home" event from 6-8pm noDivWrap](@/content/posts/iphone-action-button-commute-shortcut/screenshot-calendar-commuting-event.jpg)
...
<Grid columns={[1, 1]}>
    ...
    ![Screenshot of the Action Button settings screen in iOS](@/content/posts/iphone-action-button-commute-shortcut/screenshot-ios-action-button.png)

    ![REPLACE THIS WITH UPDATED PHOTO](@/content/posts/iphone-action-button-commute-shortcut/screenshot-ios-shortcut-selection.png)
