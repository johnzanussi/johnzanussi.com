...
coverImage:
    url: ~photo-christmas-led-strip-wled-logo.jpg
    width: 1600
    height: 900
date: '2021-12-09'
---
...
![Example of multi-color Christmas string lights](~photo-multi-color-christmas-string-lights.jpg)
...
![Screen shot of five segments in WLED interface](~wled-christmas-light-segment-settings.jpg)
...
![Screen shot of Christmas preset in WLED interface](~screenshot-wled-christmas-lights-preset.png)
...
![Dimly lit office corner with christmas LEDs](~photo-wled-christmas-lights.jpg)
