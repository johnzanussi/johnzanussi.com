...
cover: "@assets/posts/3d-printer-psu-control/diagram-pi-power-relay.jpg"
date: '2021-10-29'
hasAmazonLinks: true
---
...
![Top view of printed enclosure, a Raspberry Pi 4, and the IoT Power Relay](@assets/posts/3d-printer-psu-control/equipment-pi-case-power-relay-rpi-4.jpg)
...
![Top view of all the listed parts](@assets/posts/3d-printer-psu-control/parts-list.jpg)
...
![A diagram showing the wiring connections between the Raspberry Pi 4 and IoT Power Relay](@assets/posts/3d-printer-psu-control/diagram-pi-power-relay.jpg)
...
![Wiring between Raspberry Pi 4 dupont connector and female barrel connector](@assets/posts/3d-printer-psu-control/wiring-rpi-to-print-enclosure.jpg)

![Wiring between female barrel connector and IoT Relay screw terminal](@assets/posts/3d-printer-psu-control/wiring-print-enclosure-to-psu.jpg)
...
![Back of the printed enclosure with the female barrel connector installed](@assets/posts/3d-printer-psu-control/pi-enclosure-with-barrel-connector.jpg)

![Top view of the Raspberry Pi 4 in the printed enclosure and the female barrel connector installed](@assets/posts/3d-printer-psu-control/pi-enclosure-with-rpi-and-barrel-connector.jpg)
...
![Side view of the Ender 3 with IoT Power Relay stuck to the side of the Ender 3's PSU](@assets/posts/3d-printer-psu-control/ender-3-with-raspberry-pi-controlled-power.jpg)
...
![Screenshot of the PSU Control plguin for OctoPrint](@assets/posts/3d-printer-psu-control/screenshot-octoprint-psu-control-settings.png)
...
![Screenshot of the PSU Control - RPI.GPIO plguin for OctoPrint](@assets/posts/3d-printer-psu-control/screenshot-octoprint-psu-control-settings-gpio.png)
...
![Screen shot of OctoPrint's top navigation bar with the PSU plugin's lightning bolt icon green signifying power on](@assets/posts/3d-printer-psu-control/screenshot-octoprint-nav-bar.jpg)
