...
coverImage:
    url: ~cover-unifi-sonos-home-assistant.jpg
    width: 1600
    height: 900
date: '2021-11-05'
hasAmazonLinks: true
...
![Screenshot of the left hand navigation in Home Assistant with the File Editor link active](~screenshot-home-assistant-file-upload-nav.png)

3. Scroll down and select the `www` directory and then click the up arrow icon to bring up the "Upload File" modal.

![Screenshot of the File Editor interface in Home Assistant with the Upload File icon active](~screenshot-home-assistant-upload-file-button.png)
...
![screenshot-home-assistant-automation-triggers.png](~screenshot-home-assistant-automation-triggers.png)
...
![screenshot-home-assistant-automation-triggers.png](~screenshot-home-assistant-automation-actions.jpg)
