...
This past summer, I took Natalia and one of her friends to see <i>Despicable Me 4</i> in theaters. Even though it was only July, halfway through the movie, I found myself thinking about how perfect a Minion pumpkin would be for this year's contest—specifically one with an animated eye.
...
<div class="w-50 mx-auto">
    ![Video of a pumpkin painted like a Minion with an animated blinking eye](@/content/posts/minions-pumpkin-animated-eye/minions-pumpkin.gif)
</div>
...
## Part 2: How To
Now let's get into what exactly I used and how I connected it all together to create this award winning masterpiece. <Emoji label="wink">😉</Emoji>
