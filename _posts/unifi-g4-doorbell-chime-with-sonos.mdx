...
I've created two "Actions". One to set the volume of the speaker to 65% and the other to play the file we uploaded to Home Assistant.
...
![screenshot-home-assistant-automation-triggers.png](/assets/posts/unifi-g4-doorbell-chime-with-sonos/screenshot-home-assistant-automation-actions.png)
...
<YouTubeEmbed id="NE0VtO4plXk">
https://youtu.be/NE0VtO4plXk
</YouTubeEmbed> 
