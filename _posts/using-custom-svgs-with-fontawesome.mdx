...
coverImage:
  url: /assets/posts/using-custom-svgs-with-fontawesome/screenshot-font-awesome-code-example.jpg
  width: 1600
  height: 900
date: '2021-11-01'
---
...
![Screeshot of the free Thingiverse svg on worldvectorlogo.com](/assets/posts/using-custom-svgs-with-fontawesome/screenshot-vector-thingiverse-logo-svg.png)
...
```svg filename=thingiverse-logo.svg
...
```js filename=components/IconThingiverse.js
const prefix = 'fajz';
