...
<img className="img-fluid mw-100 h-auto mt-3 mb-2" layout="fixed" alt="Ecobee thermostat Installation Settings screen" src="/assets/posts/wireless-ecobee-mini-split-home-assistant/ecobee-installation-settings.jpg" width="600" height="450" />
4\. Tap “Equipment”

<img className="img-fluid mw-100 h-auto mt-3 mb-2" layout="fixed" alt="Ecobee thermostat Equipment settings screen" src="/assets/posts/wireless-ecobee-mini-split-home-assistant/ecobee-equipment.jpg" width="600" height="450" />
5\. Tap “Reconfigure Equipment”

<img className="img-fluid mw-100 h-auto mt-3 mb-2" layout="fixed" alt="Ecobee thermostat Homeowner or Pro? settings screen" src="/assets/posts/wireless-ecobee-mini-split-home-assistant/ecobee-homeowner-or-pro.jpg" width="600" height="450" />
6\. Select “I’m a homeowner” and tap “Next”

<img className="img-fluid mw-100 h-auto mt-3 mb-2" layout="fixed" alt="Ecobee thermostat Wire Detection screen" src="/assets/posts/wireless-ecobee-mini-split-home-assistant/ecobee-wire-detection.jpg" width="600" height="450" />
7\. Select “No, Rc and Rh are connected” and tap “Next”

<img className="img-fluid mw-100 h-auto mt-3 mb-2" layout="fixed" alt="Ecobee thermostat Previouly Configured Wiring Confirmation screen" src="/assets/posts/wireless-ecobee-mini-split-home-assistant/ecobee-prev-configured-wiring-correct.jpg" width="600" height="450" />
8\. A diagram showing which wiring terminals are configured should be visible with the question “Is this correct?”. Tap “No”.

<img className="img-fluid mw-100 h-auto mt-3 mb-2" layout="fixed" alt="Ecobee thermostat Previously Configured Wiring Modify screen" src="/assets/posts/wireless-ecobee-mini-split-home-assistant/ecobee-prev-configured-wiring.jpg" width="600" height="450" />
...
<img className="img-fluid mw-100 h-auto mt-3 mb-2" layout="fixed" alt="Ecobee thermostat Manual Wiring Configuration screen" src="/assets/posts/wireless-ecobee-mini-split-home-assistant/ecobee-manual-wire-config.jpg" width="600" height="450" />
...
<img className="img-fluid mw-100 h-auto mt-3 mb-2" layout="fixed" alt="Ecobee thermostat Accessory Options screen" src="/assets/posts/wireless-ecobee-mini-split-home-assistant/ecobee-accessory-options.jpg" width="600" height="450" />
11\. On the next screen select “No accessory installed” and tap “Next”.

<img className="img-fluid mw-100 h-auto mt-3 mb-2" layout="fixed" alt="Ecobee thermostat Temperature Scale screen" src="/assets/posts/wireless-ecobee-mini-split-home-assistant/ecobee-f-or-c.jpg" width="600" height="450" />
