...
![8U network rack with devices in it](/assets/posts/rack-mounting-ha-yelllow/network-rack-v1.jpg)
...
![Screenshot of rack module Fusion 360 model](/assets/posts/rack-mounting-ha-yelllow/rack-module-frame-f360-model.jpg)

![Custom printed and original panel modules](/assets/posts/rack-mounting-ha-yelllow/custom-and-original-panel-modules.jpg)
...
![Screenshot of HA Yellow Fusion 360 model](/assets/posts/rack-mounting-ha-yelllow/ha-yellow-mount-f360-model.jpg)

![Corner view of HA Yellow in 3D printed rack mount panel](/assets/posts/rack-mounting-ha-yelllow/ha-yellow-rack-mount-corner-view.jpg)

![Front view of HA Yellow in 3D printed rack mount panel](/assets/posts/rack-mounting-ha-yelllow/ha-yellow-rack-mount-front-view.jpg)

![Back view of HA Yellow in 3D printed rack mount panel](/assets/posts/rack-mounting-ha-yelllow/ha-yellow-rack-mount-back-view.jpg)
...
![Rack mounted HA Yellow](/assets/posts/rack-mounting-ha-yelllow/rack-mounted-ha-yellow.jpg)
...
![Modification of original panel module notch cut in corner](/assets/posts/rack-mounting-ha-yelllow/original-panel-module-modification.jpg)
...
![Custom barrel jack keystone insert](/assets/posts/rack-mounting-ha-yelllow/barrel-jack-keystone-insert.jpg)

![Front view of patch panel with USB, Ethernet, and custom barrel jack keystone inserts](/assets/posts/rack-mounting-ha-yelllow/ha-yellow-rack-mount-patch-panel-front-view.jpg)

![Back view of patch panel with USB, Ethernet, and custom barrel jack keystone inserts](/assets/posts/rack-mounting-ha-yelllow/ha-yellow-rack-mount-patch-panel-back-view.jpg)
...
![Screenshot of Raspberry Pi 4 panel module Fusion 360 model](/assets/posts/rack-mounting-ha-yelllow/raspberry-pi-4-rack-mount-panel-f360-model.jpg)

![Corner view of Raspberry Pi 4 panel module](/assets/posts/rack-mounting-ha-yelllow/raspberry-pi-4-rack-mount-panel-corner-view.jpg)
...
I still have some cable management to do, but this is what the setup looks like now. Overall I'm satisfied with the result. Going back to the list of problems to solve, I checked them all off.

![8U home network rack](/assets/posts/rack-mounting-ha-yelllow/8u-network-rack.jpg)

![8U home network rack with shelf](/assets/posts/rack-mounting-ha-yelllow/8u-network-rack-with-shelf.jpg)
