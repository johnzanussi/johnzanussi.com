    ...
    return (
        ...
        <Layout>
            ...
            <p>
                ...
                After live sports, YouTube is where I consume most video content.
                Every so often, a friend or colleague will ask about the channels I watch, so this is my way of addressing these requests.
                The following list is not all of the channels I subscribe to, but these are the channels that I watch regularly.
                The channels with the <FontAwesomeIcon icon={faBell} title="bell icon" /> icon are channels that I receive notifications when new videos are posted.
            </p>
                    ...
                    return (
                        ...
                        <div
                            ...
                            <ul className="list-unstyled">
                                ...
                                {channels.map(({ channel_name, channel_url, has_notifications }) => {
